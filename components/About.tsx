...
const About: React.FC = () => (
  ...
  >
    <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row justify-between items-start gap-12 md:gap-24">
      ...
      <div className="flex-1 text-left" data-aos="fade-up">
        <p className="text-base sm:text-lg md:text-xl leading-relaxed mb-1 text-[#EDF0DA] font-bold">
          Our team specializes in custom woodworking,
          furniture making, cabinetry, and renovations, always focusing on precision and attention
          to detail.
        </p>
        <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-4 text-white/80">
        ...
        <ul className="space-y-4 mb-6">
          <li className="flex items-start gap-3">
            ...
            <span className="text-lg md:text-xl text-[#EBEED8]">
  ...
  <span
    className="
      ...
      border-t-4 border-l-4 border-[#A67C52]
  ...
  <span
    className="
      ...
      border-b-4 border-r-4 border-[#A67C52]
      z-10 transition-all duration-300
      group-hover:translate-x-2 group-hover:translate-y-2
    "
  />
